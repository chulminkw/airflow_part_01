...
with DAG(
    dag_id="schedule_interval_context_01",
    start_date=datetime(2026, 1, 1, tz="Asia/Seoul"), # 현재 수행 일자 보다 2일전 일자로 설정
    schedule="@daily",
    ...
    def print_scheduling_context(**context):
        ...
        print("========== DAG Run id, Run Type, Timezone ==========")
        print(f"run_id: {run_id}, run_type: {run_type}")
        print(f"DAG timezone:{timezone_value}")

        print("\n========== logical_date, ds, data_interval  ==========")
